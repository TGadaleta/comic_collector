"""
Django settings for comic_collector project.
...
SECRET_KEY = 'django-insecure-mm*rrma_apa9#^_$)n5+9i2j+xxgrtaxx#p%im1%(%la_!ul2m'
...
ROOT_URLCONF = 'comic_collector.urls'
...
WSGI_APPLICATION = 'comic_collector.wsgi.application'
